 ...
 * Run this script periodically (e.g., monthly) to calculate commissions
 * 
 ...
 */
function getDateRange(periodType, monthStr) {
  const now = new Date();
 ...
 */
async function generateCommissionForOrg(org, startDate, endDate, periodType) {
  console.log(`\n📊 Processing: ${org.name}`);
...
module.exports = { generateCommissions };
